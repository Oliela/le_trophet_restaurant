...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    prix: 2000,
    image: platImage("accras-de-poisson"),
  ...
  },
  {
    ...
    prix: 2200,
    image: platImage("salade-avocat-mangue"),
    badges: ["Végétarien"],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 2000,
    image: platImage("samoussas-de-boeuf"),
    badges: ["Épicé"],
    disponibilite: "disponible",
    recommandation: false,
  },
  ...
  },
  {
    ...
    prix: 3500,
    image: platImage("sauce-arachide"),
    badges: [],
    disponibilite: "disponible",
    recommandation: false,
  },
  ...
  },
  {
    ...
    prix: 5500,
    image: platImage("capitaine-braise"),
    badges: ["Populaire"],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 3800,
    image: platImage("brochettes-de-boeuf"),
    badges: ["Épicé"],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 4200,
    image: platImage("alloco-poulet-fume"),
    badges: ["Sur commande"],
  ...
  // Incontournables (identiques aux meilleures ventes de la page d'accueil)
  {
    ...
    prix: 2500,
    image: "/images/plats/plat-garba.jpg",
    badges: ["Populaire"],
    disponibilite: "disponible",
    recommandation: true,
  },
  {
    ...
    prix: 4500,
    image: "/images/plats/plat-kedjenou.jpg",
    badges: ["Populaire"],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 5000,
    image: "/images/plats/plat-poisson-braise.jpg",
    badges: ["Épicé", "Populaire"],
    disponibilite: "disponible",
    recommandation: false,
  },
  ...
  // Desserts
  {
    ...
    prix: 1500,
    image: platImage("beignets-sucres"),
    badges: ["Végétarien"],
    disponibilite: "disponible",
    recommandation: true,
  },
  {
    ...
    prix: 1800,
    image: platImage("salade-fruits-tropicaux"),
    badges: ["Végétarien"],
    disponibilite: "disponible",
    recommandation: false,
  },
  ...
  // Cocktails
  {
    ...
    prix: 3500,
    image: boissonImage("ti-punch-ivoirien"),
    badges: ["Populaire"],
    disponibilite: "disponible",
    recommandation: true,
  },
  {
    ...
    prix: 3800,
    image: boissonImage("passion-punch"),
    badges: [],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 3800,
    image: boissonImage("bissap-cocktail"),
    badges: ["Épicé"],
    disponibilite: "disponible",
    recommandation: false,
  },
  ...
  // Mocktails
  {
    ...
    prix: 1800,
    image: boissonImage("bissap-glace"),
    badges: ["Végétarien"],
    disponibilite: "disponible",
    recommandation: true,
  },
  {
    ...
    prix: 2000,
    image: boissonImage("gingembre-fizz"),
    badges: ["Épicé"],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 2000,
    image: boissonImage("ananas-menthe"),
    badges: ["Végétarien"],
    disponibilite: "disponible",
    recommandation: false,
  },
  ...
  // Boissons chaudes
  {
    ...
    prix: 1200,
    image: boissonImage("cafe-ivoirien"),
    badges: [],
    disponibilite: "disponible",
    recommandation: true,
  },
  {
    ...
    prix: 1200,
    image: boissonImage("the-gingembre"),
    badges: ["Épicé"],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 1500,
    image: boissonImage("chocolat-chaud"),
    badges: ["Végétarien"],
    disponibilite: "disponible",
    recommandation: false,
  },
  ...
  },
  {
    ...
    prix: 1200,
    image: boissonImage("jus-gingembre"),
    badges: ["Épicé"],
    disponibilite: "disponible",
    recommandation: false,
  },
  {
    ...
    prix: 800,
    image: boissonImage("eau-minerale"),
    badges: [],
    disponibilite: "disponible",
    recommandation: false,
  },
